# Pour une partie de Donjons & Dragons, chaque joueur commence par générer un personnage avec lequel il peut jouer. Ce personnage possède, entre autres, six attributs/statistiques :
import random
import json
# Avec la définition des points au hasard
class Character():
...
# Créez une classe appelée Characteret une classe appelée Gamepour cet exercice.
class Game():
    def start(self):
