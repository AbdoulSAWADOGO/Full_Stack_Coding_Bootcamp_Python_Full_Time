...
#Utilisation de la liste de sandwich donnée
print("La charcuterie n'a plus de Pastrami")
finished_sandwiches=[]
sandwich_orders = ["Tuna sandwich", "Avocado sandwich","Pastrami sandwich", "Egg sandwich", "Sabih sandwich", "Pastrami sandwich","Pastrami sandwich","Pastrami sandwich"]
print("Liste initiale ", sandwich_orders)
...
while sandwich_orders != [] :
     ...
     if int(etat_sandwich):
        ...
        sandwich_orders.remove(sandwich_orders[0])
        print("la liste des sandwichs prêts",finished_sandwiches)
print("La liste des sandwichs finis ", finished_sandwiches)
